(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7c9969._.js", {
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(endpoint, payload, {
                withCredentials: true
            });
            if (res.data && res.data.message === 'Login successful') {
                ...
                window.location.href = role === 'barber' ? '/dashboard/barberDash' : '/dashboard/clientDash';
            } else {
...
_s(LoginPage, "jw4LdYxv7JWB8y8oYeHRH7yGigk=");
_c = LoginPage;
var _c;
...
//# sourceMappingURL=_7c9969._.js.map